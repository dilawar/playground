...
size(300,300,keepAspect=false);
//currentprojection=perspective(100,100,100);
//currentprojection=orthographic(10,100,100);
...
surface s1=surface(f1,(0,0),(4pi,10),8,8,Spline); 
surface s2=surface(f2,(0,0),(4pi,10),8,8,Spline); 
surface s3=surface(f3,(0,0),(4pi,10),8,8,Spline); 
surface s4=surface(f4,(0,0),(4pi,10),8,8,Spline); 
